...
Create a new version of the data with the land IDs separated into separate variables for an analysis of the number of observations in this data and reorder the barrels:
...
bullet_train_raw_expanded <-
  ...
  mutate(barrel1 = fct_relevel(barrel1, paste0("Br", 1:10), "BrUnk"),
         barrel2 = fct_relevel(barrel2, paste0("Br", 1:10), "BrUnk"))
```
...
**XXX Need to determine why the number of dimensions do not match. XXX**
