...
bullet_train <- 
  ...
  # 5. Add abbreviations infront of barrel, bullet, and land labels
  mutate(
  ...
  # 8. Reorder the variables
  select(land_id1, land_id2, 
         study1, barrel1, bullet1, study2, land1, barrel2, bullet2, land2,
         all_of(rtrees_features), same_source)
```
...
The updated signature identification labels are included below:
