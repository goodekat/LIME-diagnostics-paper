...
The code below removes observations based on Eric Hare's code (available [here](ttps://github.com/erichare/imaging-paper/blob/master/code/full_run.R)), which he thinks may be the code used to train `rtrees`:
