...
The discrepancy in the number of observations has led us to decide to train a new random forest model using the data provided by Heike where `flag == FALSE` (observations known to not have tank rash). The code for the random forest can be found in the document `paper.Rnw`.
