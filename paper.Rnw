...
% \begin{figure*}[!thp]
% <<bullet-expl-scat-density, out.width = '\\textwidth', fig.width = 12, fig.height = 8, fig.align = "center">>=
% bullet_es_NM <- 
%   plot_explain_scatter(
