...
<<converting-static-figs-to-eps>>=

# Convert the bullet figure to eps (if needed)
if (!file.exists("./figure-static/figure-08.eps")) {
  bullets <- image_read("./figure-static/figure-08.png")
  image_write(bullets, path = "./figure-static/figure-08.eps", format = "eps")
}

# Convert the signature figure to eps (if needed)
if (!file.exists("./figure-static/figure-09.eps")) {
  signatures <- image_read("./figure-static/figure-09.png")
  image_write(signatures, path = "./figure-static/figure-09.eps", format = "eps")
}
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.25in]{./figure-static/figure-08.eps}
...
\includegraphics[width=2.25in]{./figure-static/figure-09.eps}
...
if (file.exists("./figure-static/figure-10.eps")) {

  # Load and print the plot
  knitr::include_graphics("./figure-static/figure-10.eps")
  ...
  ggplot2::ggsave(
    plot = bullet_pcp,
    filename = "./figure-static/figure-10.png",
    width = 7.5,
    height = 3.5,
    units = "in",
    dpi = 1200
  ...
  bullet_pcp <- image_read("./figure-static/figure-10.png")
  image_write(bullet_pcp, path = "./figure-static/figure-10.eps", format = "eps")
