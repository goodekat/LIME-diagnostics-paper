...
plot_metrics(bullet_explain %>% mutate(label = as.factor(label)), add_lines = TRUE) +
  theme_bw(base_family = "Times") +
  theme(strip.background = element_rect(color = "white", fill = "white"))
@
\caption{Plot of LIME assessment metrics for the 36 different applications of LIME applied to the bullet comparison data test set. The shape of the points represents the power used for the Gower distance calculation, and the color of the points represents the rank associated with that observation within a metric. The density simulation methods perform well for all metrics, but the bin based metrics often do not agree in terms of performance across metrics. \kgc{Something is wrong here. Right now, there are repetitions of some tuning parameter combinations.}}
...
eoi1_3qb <- plot_explain_scatter(bullet_explain_perms[1:3,], alpha = 0.9, weights = FALSE) +
  scale_color_gradient2(low = "grey50",
                        high = "darkorange",
                        midpoint = 0.5,
                        limits = c(0, 1)) +
...
eoi2_3qb <- plot_explain_scatter(bullet_explain_perms[4:6,], alpha = 0.9, weights = FALSE) +
  scale_color_gradient2(low = "grey50",
                        high = "darkorange",
                        midpoint = 0.5,
                        limits = c(0, 1)) +
...
eoi1_3eb <- plot_explain_scatter(bullet_explain_perms[7:9,], alpha = 0.9, weights = FALSE) +
  scale_color_gradient2(low = "grey50",
                        high = "darkorange",
                        midpoint = 0.5,
                        limits = c(0, 1)) +
...
eoi2_3eb <- plot_explain_scatter(bullet_explain_perms[10:12,], alpha = 0.9, weights = FALSE) +
  scale_color_gradient2(low = "grey50",
                        high = "darkorange",
                        midpoint = 0.5,
                        limits = c(0, 1)) +
...
eoi1_kd <- plot_explain_scatter(bullet_explain_perms[13:15,], alpha = 0.9, weights = FALSE) +
  scale_color_gradient2(low = "grey50",
                        high = "darkorange",
                        midpoint = 0.5,
                        limits = c(0, 1)) +
...
eoi2_kd <- plot_explain_scatter(bullet_explain_perms[16:18,], alpha = 0.9, weights = FALSE) +
