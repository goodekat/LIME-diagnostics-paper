...
The R package \emph{limeaid} \footnote{Available on GitHub at https://github.com/goodekat/limeaid} (\Sexpr{packageVersion("limeaid")}) implements diagnostic plots based on the output of the altered version of `lime`.
