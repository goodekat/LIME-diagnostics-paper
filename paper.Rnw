...
\begin{figure*}[!thp]
<<concept-plot-good, out.width = '6.5in', fig.width = 7.95, fig.height = 3.75, warning = FALSE>>=
...
ggplot() +
  ...
  labs(x = "",
       ...
       alpha = "Weight",
       size = "Weight") +
  theme_linedraw(base_family = "Times", base_size = 8) +
...
<<concept-plot-bad, out.width = '6.5in', fig.width = 7.95, fig.height = 3.75, warning = FALSE>>=
...
\begin{figure*}[!thp]
\centering
<<sine-plot-data, out.width = '6.5in', fig.width = 8, fig.height = 3.1>>=
...
\begin{figure*}[!thp]
<<sine-exp-scatter, out.width = '6.5in', fig.width = 12, fig.height = 4.68, warning = FALSE>>=
...
\begin{figure}[!thp]
<<concept-feat-heat, out.width = '3.125in', fig.width = 6, fig.height = 3>>=
...
<<sine-feat-heat, out.width = '3.125in', fig.width = 4, fig.height = 4.5>>=
...
\begin{figure}[!thp]
<<sine-assess-metric, out.width = '3.25in', fig.width = 4.5, fig.height = 3.75, warning = FALSE>>=
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.75in]{./figure-static/bullets.png}
...
\includegraphics[width=3.125in]{./figure-static/signatures.png}
...
\begin{figure*}[!thp]
<<bullet-plot-rfpcp, out.width = '6.5in', warning = FALSE>>=
...
\begin{figure*}[!thp]
<<bullet-feature-heatmap, out.width = '6.5in', fig.width = 18, fig.height = 12>>=
...
<<bullet-assess-metric, out.width = '6.5in', warning = FALSE, fig.width = 10, fig.height = 4>>=
...
\begin{figure*}[!thp]
<<bullet-eois, out.width = '6.25in', fig.width = 12, fig.height = 17, message = FALSE>>=
# Join the plots
plot_grid(
  pf2_3qb,
  pf2_3eb,
...
\begin{figure*}[!thp]
<<sine-expl-scat-density, out.width = '6.5in', fig.width = 12, fig.height = 4.5, fig.align = "center">>=
...
\begin{figure*}[!thp]
<<bullet-expl-scat-density, out.width = '6.5in', fig.width = 12, fig.height = 9, fig.align = "center">>=
bullet_es_NM <-
  plot_explain_scatter(
...
\begin{figure}[!thp]
<<sine-plot-resids, out.width = '3.125in', fig.width = 5, fig.height = 4, warning = FALSE>>=
