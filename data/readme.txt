...
manuscript-code.r: Contains all of the code used to produce the results and visualizations in the manuscript. Note, this file assumes the data files are contained in a folder called data and this file is in a folder above the data folder.
