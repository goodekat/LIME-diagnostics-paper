...
organization):
  ...
  - [`01-raw-file-compression.Rmd`](code/01-raw-file-compression.Rmd)/`.html`
    ...
    uploaded to GitHub
  - [`02-data-preparation.Rmd`](code/02-data-preparation.Rmd)`/.html`
  ...
  - [`03-submission-steps.Rmd`](code/03-submission-steps.Rmd)`/.html`
